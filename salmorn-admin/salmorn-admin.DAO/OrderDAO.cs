...
namespace salmorn_admin.DAO
{
    public class OrderDAO : BaseDAO
    {
        ...
        {
            var datas = context.T_Order.SingleOrDefault(m => m.id == id);
            return datas;
        }
        ...
        public T_Order makeOrderPay(int id, DateTime payDate)
        {
        ...
        {
            var data = context.T_Order.SingleOrDefault(m => m.id == item.id);
            if (data != null)
            {
