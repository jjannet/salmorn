...
$("#submit_btn").click(function() {
   ...
   //var pApp = document.getElementById("presentWriting");
   //var pTypewriter = new Typewriter(pApp, {
   //    loop: false
   //});
   //pTypewriter//.typeString('p').pauseFor(1000).deleteAll()
   //    .pauseFor(2000)
   //    .typeString("Patchanan's fan club present").start();
   ...
   if ($("#typewriting").length) {
      ...
      typewriter//.typeString('กิจกรรมร่วมชมภาพยนต์ APPWAR')//.pauseFor(1000).deleteAll()
          //.pauseFor(6000)
          //.typeString("APPWAR MEETING")
          .start();//.pauseFor(2000);//.deleteAll()
